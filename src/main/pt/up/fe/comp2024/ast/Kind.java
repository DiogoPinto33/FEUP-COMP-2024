...
public enum Kind {
    ...
    private static final Set<Kind> STATEMENTS = Set.of(
            BLOCK_STMT, IF_ELSE_STMT, WHILE_STMT, EXPR_STMT, ASSIGN_STMT, RETURN_STMT);
    private static final Set<Kind> EXPRESSIONS = Set.of(
            BINARY_EXPR, ARRAY_ACCESS_EXPR, LENGTH_EXPR, METHOD_CALL_EXPR, NEW_ARRAY_SIZE_EXPR, NEW_CLASS_EXPR,
            UNARY_OP_EXPR, PAREN_EXPR, NEW_ARRAY_EXPR, INTEGER_LITERAL, BOOLEAN_LITERAL, VAR_REF_EXPR);
